...
public class PO_addanotherorg_standardplan extends TestBase{
	private NavigatetoXero testData;

	public PO_addanotherorg_standardplan(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//section[@id='Early']//div//div//label//div")
