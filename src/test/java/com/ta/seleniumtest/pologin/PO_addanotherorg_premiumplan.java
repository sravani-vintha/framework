...
public class PO_addanotherorg_premiumplan extends TestBase{
	private NavigatetoXero testData;

	public PO_addanotherorg_premiumplan(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//section[@id='Established']//div//div//label//div")
