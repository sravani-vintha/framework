...
public class po_addanotherorg extends TestBase {
	private NavigatetoXero testData;

	public po_addanotherorg(WebDriver driver) {
		this.driver = driver;
	...
	public void correctLogin(String username, String password, String business, String Industry)
		...
		oBroUtil.explicitWaitfunc(btn_start, 10);
		oBroUtil.ufClick(btn_start);
